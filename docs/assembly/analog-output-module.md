...
\*The analog output module is a general purpose DAC. High definition sound playback is available via the [HiFi module](../module-serial-interfaces/hifi-module-serial-interface.md).
## Bill of Materials
### 4Ch AOM v1
